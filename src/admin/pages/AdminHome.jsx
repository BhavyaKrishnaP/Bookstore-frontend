                    ...
                    <div className="md:grid grid-cols-3">
                        ...
                        <div className="md:px-10 px-5">
                            <div className="bg-green-900 p-4 flex rounded text-white">
                                <FontAwesomeIcon icon={faUsers} className='fa-3x me-2' />
                                <div>
                        ...
                        <div className="md:px-10 px-5">
                            <div className="bg-yellow-600 p-4 flex rounded text-white">
                                <FontAwesomeIcon icon={faUserTie} className='fa-3x me-2' />
                                <div>
                                    <h1 className='text-lg'>Total No. of Employees</h1>
                                    <h1 className='text-3xl'>100+</h1>
                                </div>
                            </div>
                        </div>
